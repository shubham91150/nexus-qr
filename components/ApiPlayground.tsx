          ...
          <div className="flex gap-4">
            <div className="flex-1 relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 p-0 flex items-center justify-center text-gray-400 hover:text-gray-200 focus:text-gray-200 focus:outline-none transition-colors"
              >
