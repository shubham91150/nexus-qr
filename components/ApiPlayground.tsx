          ...
          <div className="flex gap-4">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full bg-gray-100 border-0 rounded-full px-4 py-2.5 pr-12 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E5FF00] text-sm"
              />
              <button
                type="button"
            ...
            <div className="p-5 border-b border-gray-100">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between bg-gray-100 rounded-[12px] px-4 py-3 text-left hover:bg-gray-200 transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <span className={`px-2 py-1 rounded-full text-xs font-bold ${METHOD_COLORS[selectedEndpoint.method].bg} ${METHOD_COLORS[selectedEndpoint.method].text}`}>
                ...
                {isDropdownOpen && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-[16px] shadow-xl z-50 max-h-80 overflow-y-auto">
                    {API_ENDPOINTS.map((endpoint) => (
                      ...
                      >
                        <span className={`px-2 py-1 rounded-full text-xs font-bold ${METHOD_COLORS[endpoint.method].bg} ${METHOD_COLORS[endpoint.method].text}`}>
                          {endpoint.method}
                        </span>
                        <div>
