        ...
        <InputWrapper>
          <div className="flex flex-col gap-1">
            <label className="text-xs text-gray-500 ml-1 flex items-center gap-2">
              ...
              LinkedIn Profile URL Slug
            </label>
            <DebouncedInput placeholder="satyanadella (from linkedin.com/in/satyanadella)" value={data.linkedin?.username || ''} onChange={(v) => updateNested('linkedin', 'username', v)} />
          </div>
          <p className="text-xs text-gray-400 px-1">
            Enter the username from the profile URL, not the display name.
          </p>
          <div className="flex flex-col gap-1">
